...
pub use self::commands::{
    ...
    EditInstance, InstanceLaunchOverridesPatch, InstanceMetadata,
};
pub(crate) use self::commands::{
    content_game_dir, dependencies_to_content_items,
    finalize_project_materialization, get_content_projects,
    get_installed_project_ids_for_instance, get_instance_install_candidates,
    get_linked_modpack_info, instance_content_root, list_content,
...
pub(crate) use self::commands::{
    ...
    remove_instance, restore_instance_metadata,
};
