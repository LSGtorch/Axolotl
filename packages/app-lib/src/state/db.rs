...
mod tests {
    ...
    // Fork release history published this migration as 20260823120003 (it was
    // renumbered above the already-published 20260823120000 direct-link
    // migration); upstream carries it as 20260823020000.
    const MCARCHIVE_PROVIDER_FILE_ID_MIGRATION_VERSION: i64 = 20260823120003;
