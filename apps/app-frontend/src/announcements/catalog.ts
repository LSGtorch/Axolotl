...
export const launcherAnnouncements: readonly LauncherAnnouncement[] = [

	{
		...
		title: {
			'en-US': 'Axolotl Launcher 99.99.6 (test)',
			'zh-CN': 'Axolotl Launcher 99.99.6（测试版）',
		},
		changes: {
			fixed: [
				{
					'en-US':
						'Synced the latest upstream fixes: crash analysis no longer flashes a PowerShell window, legacy-Forge native handling keeps lwjgl variant jars, and mixed native library versions are prevented.',
					'zh-CN':
						'同步最新上游修复：崩溃分析不再弹出 PowerShell 窗口、legacy Forge 原生库保留 lwjgl 变体 jar、并阻止混装不同版本的原生库。',
				},
			],
		},
	},
	...
	},
	{
		...
		publishedAt: '2026-08-28',
		title: {
			'en-US': 'Axolotl Launcher 99.99.4 (test)',
			'zh-CN': 'Axolotl Launcher 99.99.4（测试版）',
		},
		changes: {
			fixed: [
				{
					'en-US':
						'Directly associated instances no longer display a loader version; the loader is managed by the external launcher.',
					'zh-CN': '直接关联实例不再显示加载器版本号（加载器由外部启动器管理）。',
				},
				{
					'en-US':
						'Direct association is now a one-click import without loader or game version selection; description updated to mention other launchers in general.',
					'zh-CN': '直接关联改为一键导入，不再要求选择加载器/游戏版本；描述文案改为通用“其他启动器”。',
				},
			],
		},
	},,
